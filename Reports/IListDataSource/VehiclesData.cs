using AspNetCoreDemos.Reporting;
...
namespace  AspNetCoreDemos.Reporting.DataSources
{
    public class VehiclesData
    {
        static string ConnectionString
        {
            get
            {
                return Microsoft.Extensions.Configuration.ConfigurationExtensions.GetConnectionString(Startup.Configuration, "VehiclesConnection");
            }
        }
        class Trademark
        {
        ...
        public static List<Vehicle> GetVehicles(string connectionString) {
